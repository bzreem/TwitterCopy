...
import t13Icon from "../assets/img/t13Profile.jpg";
import t13ImgInfo from "../assets/img/t13.jfif";
import MaxHeader from "./MaxHeader";
import MinFooter from "./MinFooter";
import OptionToTweet from "./OptionToTweet";
import Welcome from "./Welcome";
import OptionToTweetMax from "./OptionToTweetMax";
import SearchTwitter from "./SearchInTwitter";

const MainContent = () => {
  const [mq] = useResizeWindows("(min-width: 500px)");
  const [mq2] = useResizeWindows("(min-width: 1000px)");

  return (
    <>
      <main>
        <div className="div-container-general-content">
          {mq && <MaxHeader />}
          <section className="section-container-a">
            {mq && <Welcome />}
            {mq && <OptionToTweetMax />}
            <a href="sd">
              <article>
                <figure className="figure-container-img-profile">
                  <img src={t13Icon} alt="" />
                </figure>

                <div className="div-container-information">
                  <div className="div-max-width">
                    <div className="div-container-separate-info">
                      <h4>Canal 13</h4>
                      <span>@canal13. 10min</span>
                    </div>

                    <p>
                      Terminamos esta noche de{" "}
                      <span className="span-hashtag">#AquíSeBaila</span> 👏
                    </p>
                    <p>
                      Te dejamos la invitación para mañana, noche de eliminación
                      en nuestro desafío 😨🔥
                    </p>

                    <p>
                      Después de{" "}
                      <span className="span-hashtag">#T13Central</span>, por
                      Canal 13 y 13.cl 👀
                    </p>

                    <figure className="figure-container-content-footer">
                      <img src={t13ImgInfo} alt="" />
                    </figure>

                    <div className="div-container-card-icon">
                      <div className="div-container-svg-main">
