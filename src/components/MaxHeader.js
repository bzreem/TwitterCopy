...
import "./MaxHeader.css";
import OptionToTweet from "./OptionToTweet";
import ProfileMax from "./ProfileMax";
const MaxHeader = () => {
  const [mq] = useResizeWindows("(min-width: 1300px)");
  return (
    <header className="my-max-header">
      <div className="div-container-icons-header">
        <a href="sd">
          <div className="div-container-twitter">
        ...
        <a href="ss">
          <div className="div-container-alert">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <g>
        ...
        <a href="as">
          <div className="div-container-message">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <g>
        ...
        <a href="sd">
          <div className="div-container-saved">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <g>
        ...
        <a href="as">
          <div className="div-container-more">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <g>
