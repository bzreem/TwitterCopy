import "./OptionToTweetMax.css";
import ProfileImg from "../assets/img/profile-img.jpg";
const OptionToTweetMax = () => {
  return (
    <section className="section-container-tweet-max">
      <div className="div-container-img-form">
        <figure>
        ...
        <form>
          ...
          <button>
            <div className="div-container-option-form">
              <div>
          ...
          <div className="div-container-icon-form-tweet">
            <div className="div-container-label-icon">
...
export default OptionToTweetMax;
