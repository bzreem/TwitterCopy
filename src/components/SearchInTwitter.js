import "./SearchInTwitter.css";
import ProfileImg from "../assets/img/profile-img.jpg";
const SearchTwitter = () => {
  return (
    <section className="section-container-search-in-twitter">
      <form>
      ...
      <aside>
        <article className="article-container-trends">
          <div className="div-container-trends">
          ...
          <div className="div-container-sub-title">
          ...
          <div className="div-container-name-and-tweets">
            <h3>Nikita Mazepin</h3>
            <span>1.74 M Tweets</span>
          </div>
          ...
          <div className="div-container-more-trends">
            <a href="as">Mostrar más</a>
          </div>
        </article>

        <article className="article-container-who-to-follow">
          <h2>A quién seguir</h2>

          <div className="div-container-recommendations">
            <figure>
              <img src={ProfileImg} alt="" />
            </figure>
            <div className="div-container-information-recommendation-user">
              <h3>Juanpa</h3>
              <span>@Juanpa123</span>
            </div>
